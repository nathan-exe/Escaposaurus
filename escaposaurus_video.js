...
/*folder routine HTML*/
function cFolder(name, parent, password, placeholder, seqNumber){
...
function openPasswordPrompt(foldername,placeholder){
	...
	if(sequenceFolder[sequenceNumber] == foldername){
		...
		passwordInputField.setAttribute("placeholder", placeholder)
